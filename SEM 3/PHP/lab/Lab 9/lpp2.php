...
$arithAdd = new Arithmatic(10, 5, '+');
$arithSub = new Arithmatic(10, 5, '-');
$arithMul = new Arithmatic(10, 5, '*');
$arithDiv = new Arithmatic(10, 5, '/');

$strConcat = new MyString("Hello", " World", '+');
$strPosition = new MyString("Hello World", "World", '-');
$strCount = new MyString("Hello World, World is wonderful", "World", '*');
$strLastWord = new MyString("Hello World, World is wonderful", "", '/');
